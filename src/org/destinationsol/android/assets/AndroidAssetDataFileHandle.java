 ...
 *
 * This is once again only needed in order to make the runtime not complain about missing methods.
 * @see FileHandle
 */
public class AndroidAssetDataFileHandle extends FileHandle {
    protected AssetDataFile dataFile;

    public AndroidAssetDataFileHandle(AssetDataFile dataFile) {
